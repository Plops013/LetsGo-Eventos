					...
					<form:form action="salva" modelAttribute="evento"
						...
						<div class="form-row">
							...
							<div class="form-group col-md-4">
								...
								<form:input cssClass="form-control" path="quantidadeIngressos"
									cssErrorClass="form-control is-invalid" />
								<div class="invalid-feedback">
									<form:errors path="quantidadeIngressos" cssClass="error" />
								</div>
							</div>
							<div class="form-group col-md-4">
								<label for="casaDeShow">Casa de Show:</label> <select
									class="custom-select" required>
									<c:forEach items="${usuario.casasDeShow}" var="casaDeShow">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								...
								<form:input cssClass="form-control" path="dataFim" type="date"
									cssErrorClass="form-control is-invalid" />
								<div class="invalid-feedback">
						...
						<div class="form-row px-1">
							<label>Escolha uma foto para seu evento <span class="small text-muted">( sua foto deve ter o tamanho de 800 x 400, e no maximo 10Mb)</span>
							</label>
							<div class="form-group col-md-12 ">
