	...
	<div class="container mt-4">
		...
		<div class="card mb-4">
			<div class="card-body bg-light">
				<h1 class="text-center" id="evento">Cadastro de Casa de Show</h1>
				<div class="text-center mx-auto py-3">
					<div class="collapse show multi-collapse" id="collapseButton">
						<a class="text-white btn btn-primary py-1" type="button"
							...
							aria-controls="collapseForm collapseButton"> Abrir Formulario
						</a>
					</div>
					...
					<form:form modelAttribute="casaDeShow" action="/salva">
						...
						<div class="form-row">
							<div class="form-group col-lg-12">
								<label>Nome</label>
								<form:input cssClass="form-control" cssErrorClass="is-invalid"
									path="nome" />
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-lg-12">
								<label>CEP <span class="small">( sistema de prenchimento automatico, digite apenas o cep e o numero)</span></label> <input class="form-control col-sm-4" type="text"
									id="cep" />
							</div>
						</div>
						<div class="form-row">
							...
							<div class="form-group col-lg-3">
								<fieldset disabled>
									<label>Cidade</label>
									<form:input cssClass="form-control" cssErrorClass="is-invalid" path="cidade" />
								</fieldset>
							</div>
							<div class="form-group col-lg-3">
							<fieldset disabled>
								<label>Estado</label>
								<form:input cssClass="form-control" cssErrorClass="is-invalid" path="estado" />
							</fieldset>
							</div>
						</div>
					</form:form>
